...
### 1. 数组操作
- **简单**: 两数之和、移除元素、删除排序数组中的重复项
- **中等**: 三数之和、四数之和、盛最多水的容器、接雨水
- **困难**: 寻找两个正序数组的中位数

### 2. 链表操作
- **简单**: 合并两个有序链表、反转链表
- **中等**: 两数相加、删除链表的倒数第 N 个节点、链表相交、环形链表
- **困难**: 合并 K 个升序链表、K 个一组翻转链表

### 3. 字符串操作
- **简单**: 最长公共前缀、有效的括号、回文数、罗马数字转整数
- **中等**: 最长回文子串、最长无重复字符的子串、电话号码的字母组合
- **困难**: 编辑距离

### 4. 二叉树操作
- **简单**: 二叉树的最大深度、二叉树的最小深度、对称二叉树、相同的树
- **中等**: 二叉树的层序遍历、二叉树的中序遍历、二叉树的前序遍历、二叉树的后序遍历、二叉树的右视图、二叉树的左视图、路径总和、路径总和 II、路径总和 III
- **困难**: 二叉树中的最大路径和、从前序与中序遍历序列构造二叉树、从中序与后序遍历序列构造二叉树

### 5. 动态规划
- **简单**: 爬楼梯、最大子序和、买卖股票的最佳时机
- **中等**: 最小路径和、单词拆分
- **困难**: 买卖股票的最佳时机 III、买卖股票的最佳时机 IV

### 6. 回溯算法
- **中等**: 组合总和、组合总和 II、全排列、全排列 II、子集、子集 II、单词搜索
- **困难**: 电话号码的字母组合
...
```bash
git clone https://github.com/Geekmister/AlgorithmProblem.git
cd AlgorithmProblem
```
...
| 序号 | 题目 | 难度 | 类别 | 文件 |
|------|------|------|------|------|
| 1 | 两数之和 | 简单 | 数组操作、哈希表 | [two_sum.py](python/two_sum.py) |
| 2 | 三数之和 | 中等 | 数组操作、双指针 | [three_sum.py](python/three_sum.py) |
...
| 9 | 删除链表的倒数第 N 个节点 | 中等 | 链表操作 | [remove_nth_node_from_end_of_list.py](python/remove_nth_node_from_end_of_list.py) |
| 10 | 链表相交 | 中等 | 链表操作 | [intersection_of_two_linked_lists.py](python/intersection_of_two_linked_lists.py) |
...
| 17 | 罗马数字转整数 | 简单 | 字符串操作 | [roman_to_integer.py](python/roman_to_integer.py) |
| 18 | 最长回文子串 | 中等 | 字符串操作 | [longest_palindromic_substring.py](python/longest_palindromic_substring.py) |
...
| 25 | 相同的树 | 简单 | 二叉树操作 | [same_tree.py](python/same_tree.py) |
| 26 | 二叉树的层序遍历 | 中等 | 二叉树操作 | [binary_tree_level_order_traversal.py](python/binary_tree_level_order_traversal.py) |
| 27 | 二叉树的中序遍历 | 中等 | 二叉树操作 | [binary_tree_inorder_traversal.py](python/binary_tree_inorder_traversal.py) |
| 28 | 二叉树的前序遍历 | 中等 | 二叉树操作 | [binary_tree_preorder_traversal.py](python/binary_tree_preorder_traversal.py) |
| 29 | 二叉树的后序遍历 | 中等 | 二叉树操作 | [binary_tree_postorder_traversal.py](python/binary_tree_postorder_traversal.py) |
| 30 | 二叉树的右视图 | 中等 | 二叉树操作 | [binary_tree_right_side_view.py](python/binary_tree_right_side_view.py) |
| 31 | 二叉树的左视图 | 中等 | 二叉树操作 | [binary_tree_left_side_view.py](python/binary_tree_left_side_view.py) |
| 32 | 路径总和 | 中等 | 二叉树操作 | [path_sum.py](python/path_sum.py) |
| 33 | 路径总和 II | 中等 | 二叉树操作 | [path_sum_ii.py](python/path_sum_ii.py) |
| 34 | 路径总和 III | 中等 | 二叉树操作 | [path_sum_iii.py](python/path_sum_iii.py) |
...
| 79 | 二叉树的坡度 | 简单 | 二叉树操作 | [binary_tree_tilt.py](python/binary_tree_tilt.py) |
| 80 | 另一个树的子树 | 简单 | 二叉树操作 | [subtree_of_another_tree.py](python/subtree_of_another_tree.py) |
| 81 | 左叶子之和 | 简单 | 二叉树操作 | [sum_of_left_leaves.py](python/sum_of_left_leaves.py) |
| 82 | 找树左下角的值 | 简单 | 二叉树操作 | [find_bottom_left_tree_value.py](python/find_bottom_left_tree_value.py) |
| 83 | 验证二叉搜索树 | 中等 | 二叉树操作 | [validate_binary_search_tree.py](python/validate_binary_search_tree.py) |
| 84 | 验证二叉搜索树（中序遍历） | 中等 | 二叉树操作 | [validate_bst_inorder.py](python/validate_bst_inorder.py) |
| 85 | 二叉搜索树中第 K 小的元素 | 中等 | 二叉树操作 | [kth_smallest_element_in_a_bst.py](python/kth_smallest_element_in_a_bst.py) |
| 86 | 二叉搜索树中的众数 | 中等 | 二叉树操作 | [find_mode_in_binary_search_tree.py](python/find_mode_in_binary_search_tree.py) |
| 87 | 二叉搜索树中的最小绝对差 | 简单 | 二叉树操作 | [minimum_absolute_difference_in_bst.py](python/minimum_absolute_difference_in_bst.py) |
| 88 | 将有序数组转换为二叉搜索树 | 简单 | 二叉树操作 | [convert_sorted_array_to_binary_search_tree.py](python/convert_sorted_array_to_binary_search_tree.py) |
| 89 | 二叉搜索树的最近公共祖先 | 简单 | 二叉树操作 | [lowest_common_ancestor_of_a_binary_search_tree.py](python/lowest_common_ancestor_of_a_binary_search_tree.py) |
| 90 | 二叉树的最近公共祖先 | 中等 | 二叉树操作 | [lowest_common_ancestor_of_a_binary_tree.py](python/lowest_common_ancestor_of_a_binary_tree.py) |
| 91 | 二叉树的层序遍历 II | 中等 | 二叉树操作 | [binary_tree_level_order_traversal_ii.py](python/binary_tree_level_order_traversal_ii.py) |
| 92 | 二叉树的平均值 | 简单 | 二叉树操作 | [average_of_levels_in_binary_tree.py](python/average_of_levels_in_binary_tree.py) |
| 93 | 二叉树的最大宽度 | 中等 | 二叉树操作 | [maximum_width_of_binary_tree.py](python/maximum_width_of_binary_tree.py) |
| 94 | 序列化和反序列化二叉树 | 困难 | 二叉树操作 | [serialize_and_deserialize_binary_tree.py](python/serialize_and_deserialize_binary_tree.py) |
...
欢迎贡献更多的算法题！如果您想添加新的算法题，请遵循以下步骤：
